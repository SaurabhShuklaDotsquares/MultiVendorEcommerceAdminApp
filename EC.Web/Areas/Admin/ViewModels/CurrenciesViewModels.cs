...
{
    public class CurrenciesViewModels
    {
        public CurrenciesViewModels()
        {
            this.GetCurrencyType = new List<SelectListItem>();
        }
        ...
        public List<SelectListItem> GetCurrencyType { get; set; }
    }
    public class Root
    {
