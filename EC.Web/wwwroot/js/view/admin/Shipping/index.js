(function ($) {
    function Cms() {
        ...
        function initializeGrid() {
            var gridCms = new Global.GridHelper('#grid-Shipping', {
                "columnDefs": [
                    ...
                    },
                    {
                        ...
                        "render": function (data, type, row, meta) {
                            var actionLink = $("<a/>", {
                                href: "/admin/Shipping/Create/" + row[0],
                                id: "addModel",
                                title: "Edit",
                           ...
                           actionLink += $("<a/>", {
                                    href: domain + "/admin/Shipping/Delete/" + row[0],
                                    id: "deleteType",
                                    title: "Delete",
                                    class: "btn btn-danger btn-sm",
                                    'data-toggle': "modal",
                                    'data-target': "#modal-delete-Shipping",
                                    html: $("<i/>", {
                                        class: "fa fa-trash-alt"
                                    }),
                                }).append("").get(0).outerHTML + "&nbsp;"
                           actionLink += $("<a/>", {
                                    href: domain + "/admin/Shipping/View/" + row[0],
                                    id: "deleteType",
                                    title: "View",
                                    class: "btn btn-primary btn-sm",
                                    'data-toggle': "form",
                ...
                "bAutoWidth": false,
                "stateSave": false,
                "sAjaxSource": "/admin/Shipping/Index",
                ...
                "language": {
                    "searchPlaceholder": "Minimum order amount"
                }
            });
