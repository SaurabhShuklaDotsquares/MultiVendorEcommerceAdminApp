(function ($) {
    function Cms() {
        ...
        function initializeGrid() {
            var gridCms = new Global.GridHelper('#grid-Newsletters', {
                "columnDefs": [
                    ...
                    { "targets": [4], "sortable": true, "searchable": true },
                    {
                        ...
                        "render": function (data, type, row, meta) {
                            var actionLink = $("<a/>", {
                                href: "/admin/Newsletters/Delete/" + row[0],
                                id: "deleteType",
                                title: "Delete",
                                class: "btn btn-danger btn-sm",
                                oncontextmenu: 'return false',
                                'data-toggle': "modal",
                                'data-target': "#modal-delete-Newsletters",
                                html: $("<i/>", {
                ...
                "bAutoWidth": false,
                "stateSave": false,
                "sAjaxSource": "/admin/Newsletters/index",
        ...
        function initGridControlsWithEvents() {
            ...
            $('.switchBox').bootstrapSwitch()
                .on('switchChange.bootstrapSwitch', function () {
                    ...
                    $.get('/admin/Newsletters/ActiveNewsLettersStatus', { id: this.value }, function (result) {
                        if (!result.isSuccess) {
