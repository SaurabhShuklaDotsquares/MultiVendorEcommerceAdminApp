...
namespace EC.DataTable.Extension
{
    /// <summary>
    ...
    public class DataTableResultExt : ActionResult, IDataTableResult<List<DataTableRow>>
    {
        ...
        public DataTableResultExt(EC.DataTable.DataTables.DataTable dataTable, int iTotalRecords = 0, int iTotalDisplayRecords = 0, List<DataTableRow> aaData = null)
